...
@section('content-box')
    <div class="content-box-header">
        <h3 class="content-box-title">Novo Usuário</h3>
    ...
    <form action="{{ route('user.store') }}" method="POST">
        ...
        <div class="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="cpf" id="cpf" class="form-input" placeholder="Digite o CPF">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="number" id="number" class="form-input" placeholder="N°">
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-x-4 gap-y-2">
            <div class="mb-4">
                ...
                <input type="text" name="district" id="district" class="form-input" placeholder="">
            </div>
            <div class="mb-4">
                <label for="city" class="form-label">Cidade</label>
                <input type="text" name="city" id="city" class="form-input" placeholder="Nome da Cidade">
            </div>
        </div>
        ...
        @endforeach
            ...
            <div class="mb-4">
                ...
                <input type="text" name="zip_code" id="zip_code" class="form-input" placeholder="CEP">
            </div>
        </div>
